 ...
 */
public class MurmurHash3 implements IncrementalHasher {
	...
	public IncrementalHasher add(final short data) {
	...
	public synchronized IncrementalHasher add(byte byteData) {
	...
	public synchronized IncrementalHasher add(byte[] byteArray) {
